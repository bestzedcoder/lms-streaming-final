...
public class CourseServiceImpl implements CourseService {
  ...
  public List<InstructorCourseResponse> getAllCourses() {
    ...
    List<InstructorCourseResponse> res = courses.stream().map(CourseMapper::mapCourseToInstructorCourseResponse).toList();
  ...
  public InstructorCourseDetailsResponse getCourseDetails(UUID id) {
    ...
    return CourseMapper.mapCourseToInstructorCourseDetailsResponse(course);
  }
